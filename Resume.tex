...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item GPA: 6.95/10 (\href{https://example.com}{a link to somewhere})
                \item \textbf{Coursework:} Computer Organization, Linear Algebra, Advanced Programming, Embedded Logic Design
            \end{highlights}
        \end{onecolentry}
